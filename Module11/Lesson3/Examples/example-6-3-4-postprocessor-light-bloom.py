...
from Effects.BrightFilter import BrightFilterEffect
...
class Example(Base):
    ...
    def initialize(self):
        ...
        self.postprocessor.add_effect(BrightFilterEffect(1.5))
        self.postprocessor.add_effect(HorizontalBlurEffect(texture_size=[self._screen.get_width(), self._screen.get_height()], blur_radius=50))
        self.postprocessor.add_effect(VerticalBlurEffect(texture_size=[self._screen.get_width(), self._screen.get_height()], blur_radius=50))
